...
import { BULK, GOODS, HUBS, HUB_CAP, POST_BY_ID, POSTS, MAX_OPEN, MAX_ROUTE_DV, REGION, START_DAY, Post, bodyOf } from './world.js';
import { transfer } from './physics.js';
import { S, Eco, Order } from './state.js';
...
function pickWeighted<T>(list:T[], w:(x:T)=>number){
