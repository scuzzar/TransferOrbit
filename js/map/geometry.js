...
const ICE = [0,1]; // indices drawn as ice (Greenland = 1); North America stays land
...
export const LIGHT = (()=>{ const v=[-0.5,0.3,0.78], n=Math.hypot(...v); return v.map(x=>x/n); })(); // light from the left oben vorn
