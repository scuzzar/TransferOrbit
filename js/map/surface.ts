...
export const DESERT: [LonLat[], string][] = [
...
export const LIGHT = (():[number,number,number] => { const [x,y,z]=[-0.5,0.3,0.78], n=Math.hypot(x,y,z); return [x/n,y/n,z/n]; })(); // light from the upper left, towards the viewer
