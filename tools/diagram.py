...
BANDS=[
 ('Wiring','connects both sides, loads the save',
   [(0,None,23,'start')], True, None),
 ('Panels (DOM)','on top the two that are the only ones to know both halves; below, the plain HTML',
   [(0,0,21,'ui/display'),(0,1,22,'ui/menu'),
    (1,0,18,'ui/widgets'),(1,1,19,'ui/pickcard'),(1,2,20,'ui/panels')], False, 'Presentation'),
 ('Canvas','three layers, one picture - knows nothing of the panels',
   [(0,0,11,'map/canvas'),(0,1,12,'map/rocketdata'),(0,2,13,'map/surface'),
    (1,0,14,'map/gl'),(1,1,15,'map/rocket'),(1,2,16,'map/view'),
    (2,0,17,'map/draw')], False, 'Presentation'),
