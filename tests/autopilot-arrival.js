...
(async()=>{ const b=await chromium.launch(); const errs=[];
  ...
  console.log(await p.evaluate(()=>({node:TO.S.domain.node,site:TO.S.domain.site,view:TO.S.ui.view,mainHidden:document.getElementById('mainview').hidden,msg:TO.S.ui.msg})));
